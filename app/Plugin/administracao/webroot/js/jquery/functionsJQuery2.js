        ...
        $.post(rootOfFramework() + "/administracao/produtos/retAjaxSelect",
            {tipo:valor},
    ...
    $(document).ready(function()
    {
        ...
        {
            $.post(rootOfFramework() + "/administracao/cat2as/retAjaxSelect",
                  {tipo:$(this).val()},
                        function(valor)
                        {
                        $("select[id=Cat2a]").html(valor);
            ...
            $.post(rootOfFramework() + "/administracao/cat1as/retAjaxcamposCaracteristicasCat1",
