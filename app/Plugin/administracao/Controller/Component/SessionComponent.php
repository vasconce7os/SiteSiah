<?php
/**
 * Apenas subscrevendo SessionComponent do core do framework a adicionado algumas 
 * funçõeszinhas
...
class SessionComponent extends Component {
	 ...
	 * @author cerebro
	 */
	public function setFlashErro($message, $element = 'default', $params = array('class'=> "msgErro message"), $key = 'flash') {
		CakeSession::write('Message.' . $key, compact('message', 'element', 'params'));
	}
	 ...
	 * @author cerebro
	 */
	public function setFlashAtencao($message, $element = 'default', $params = array('class'=> "Atencao notice"), $key = 'flash') {
		CakeSession::write('Message.' . $key, compact('message', 'element', 'params'));
	}
	 ...
	 * @author cerebro
	 */
	public function setFlashSucesso($message, $element = 'default', $params = array('class'=> "msgSucesso noticeSuccess"), $key = 'flash') {
		CakeSession::write('Message.' . $key, compact('message', 'element', 'params'));
	}
